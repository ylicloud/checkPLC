# CheckPLC · TIA Openness CAx 导出工具（V20）
...
```bat
set TIA_PUBLICAPI=D:\Siemens\Portal V20\PublicAPI\V20
```
...
```bat
export.bat --project "D:\repos\checkPLC\质检查线\质检查线.ap20" --out D:\Temp\柜A.aml --new
```
